...
from sqlalchemy import BigInteger, Boolean, DateTime, Float, Index, Integer, String, JSON, UniqueConstraint
...
class ExperimentAssignment(Base):
    ...
    action_execution_id: Mapped[str | None] = mapped_column(String(40), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=_now)
...
class Outcome(Base):
    ...
    organization_id: Mapped[str] = mapped_column(String(40), index=True)
    experiment_id: Mapped[str] = mapped_column(String(40), index=True)
    assignment_id: Mapped[str] = mapped_column(String(40))
