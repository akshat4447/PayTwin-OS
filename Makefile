...
.PHONY: help setup dev api worker migrate seed demo razorpay-demo razorpay-api bench test served-e2e loadtest verify clean
...
help:
	...
	@echo "make bench     - regenerate the committed synthetic evaluation evidence"
...
bench:
	$(PY) scripts/evaluate.py --output docs/evidence/metrics_card.json
